...
#Rohit Loharkar 
#Codeclause Internship Task - Mail Application with GUI in Python
...
class MyGUI(QMainWindow):
    ...
    def __init__(self):
        ...
        uic.loadUi("Codeclause_Mail_App/MailApp.ui", self)
        self.show()

        self.pushButton.clicked.connect(self.login)
        self.pushButton_2.clicked.connect(self.attch_something)
